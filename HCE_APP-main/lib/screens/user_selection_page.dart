...
class UserSelectionPageState extends State<UserSelectionPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadUnseenMessageSenders() async {
    ...
    try {
      ...
      print('Fetching unseen message senders, user role: ${authProvider.userRole}');
      ...
      if (senders.isEmpty) {
        print('No unseen messages found - this could be expected or could indicate an issue with the backend query');
      }
                      ...
                      onTap: () async {
                        ...
                        if (token.isNotEmpty) {
                          try {
                            ...
                            await ApiService().markAllMessagesAsSeen(token, sender['_id']);
